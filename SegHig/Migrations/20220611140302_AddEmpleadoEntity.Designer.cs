...
namespace SegHig.Migrations
{
    ...
    [Migration("20220611140302_AddEmpleadoEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SegHig.Data.Entities.Empleado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SegHig.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SegHig.Data.Entities.Cliente", b =>
                {
                    b.HasOne("SegHig.Data.Entities.ClienteTipo", "ClienteTipo")
                        .WithMany("Clientes")
            ...
            modelBuilder.Entity("SegHig.Data.Entities.Empresa", b =>
                {
                    b.HasOne("SegHig.Data.Entities.EmpresaTipo", "EmpresaTipo")
                        .WithMany()
                        .HasForeignKey("EmpresaTipoId");

                    b.Navigation("EmpresaTipo");
                });

            modelBuilder.Entity("SegHig.Data.Entities.EmpresaTipo", b =>
                {
                    b.HasOne("SegHig.Data.Entities.Empresa", null)
                        .WithMany("EmpresaTipos")
                        .HasForeignKey("EmpresaId");
                });
